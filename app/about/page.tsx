...
const buildContent = (incoming?: Partial<AboutContent>): AboutContent => {
  ...
  return {
    hero: {
      ...
      ...source.hero,
      stats:
        source.hero?.stats && source.hero.stats.length > 0
          ? source.hero.stats
          : [...defaultContent.hero.stats],
      affiliation: source.hero?.affiliation
        ? { ...defaultContent.hero.affiliation, ...source.hero.affiliation }
        : defaultContent.hero.affiliation,
      cta: source.hero?.cta ? { ...defaultContent.hero.cta, ...source.hero.cta } : defaultContent.hero.cta
    },
    vision: {
    ...
    globalPresence: {
      ...defaultContent.globalPresence,
      ...source.globalPresence,
      stats:
        source.globalPresence?.stats && source.globalPresence.stats.length > 0
          ? source.globalPresence.stats
          : [...defaultContent.globalPresence.stats],
      technical: {
        ...defaultContent.globalPresence.technical,
        ...(source.globalPresence?.technical || {}),
        capabilities:
          source.globalPresence?.technical?.capabilities &&
          source.globalPresence.technical.capabilities.length > 0
            ? source.globalPresence.technical.capabilities
            : [...defaultContent.globalPresence.technical.capabilities],
        solutions:
          source.globalPresence?.technical?.solutions && source.globalPresence.technical.solutions.length > 0
            ? source.globalPresence.technical.solutions
            : [...defaultContent.globalPresence.technical.solutions],
        manufacturingHighlights:
          source.globalPresence?.technical?.manufacturingHighlights &&
          source.globalPresence.technical.manufacturingHighlights.length > 0
            ? source.globalPresence.technical.manufacturingHighlights
            : [...defaultContent.globalPresence.technical.manufacturingHighlights],
        testingItems:
          source.globalPresence?.technical?.testingItems &&
          source.globalPresence.technical.testingItems.length > 0
            ? source.globalPresence.technical.testingItems
            : [...defaultContent.globalPresence.technical.testingItems]
      }
    },
    certificates: {
      ...
      ...source.certificates,
      certifications:
        source.certificates?.certifications && source.certificates.certifications.length > 0
          ? source.certificates.certifications
          : [...defaultContent.certificates.certifications],
      patents:
        source.certificates?.patents && source.certificates.patents.length > 0
          ? source.certificates.patents
          : [...defaultContent.certificates.patents],
      achievements:
        source.certificates?.achievements && source.certificates.achievements.length > 0
          ? source.certificates.achievements
          : [...defaultContent.certificates.achievements]
    },
    history: {
      ...defaultContent.history,
      ...source.history,
      milestones:
        source.history?.milestones && source.history.milestones.length > 0
          ? source.history.milestones
          : [...defaultContent.history.milestones]
    }
  };
};
